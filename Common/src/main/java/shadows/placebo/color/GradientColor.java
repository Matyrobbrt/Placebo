...
public class GradientColor extends TextColor {
	...
	public int getValue() {
		if (Services.PLATFORM.isClient()) {
			return gradient[(int) (PlaceboClient.getColorTicks() % gradient.length)];
		}
