...
public class Wing extends EntityModel<AbstractClientPlayer> implements IWingModel {
	...
	public static LayerDefinition createLayer() {
		...
		partdefinition.getChild("bb_main").addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 0).addBox(1.0F, -8.0F, 0.0F, 16.0F, 16.0F, 0.0F, CubeDeformation.NONE.extend(0.001F)), PartPose.offsetAndRotation(0.0F, -8.0F, 0.0F, 0, .3491F, 0));
		partdefinition.getChild("bb_main").addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 0).addBox(1.0F, -8.0F, 0.0F, 16.0F, 16.0F, 0.0F, CubeDeformation.NONE.extend(0.001F)), PartPose.offsetAndRotation(0.0F, -8.0F, 0.0F, 0, -.3491F, 0));
